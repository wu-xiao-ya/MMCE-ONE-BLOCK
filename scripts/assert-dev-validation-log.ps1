...
$required = @(
    ...
    '[MMCE One Block DevValidation] applied redstone pause beside controller',
    '[MMCE One Block DevValidation] redstone pause held; filled output slots to test retry',
    '[MMCE One Block DevValidation] cleared blocked output slots for retry',
